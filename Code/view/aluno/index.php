...
<div class="container">
    <div class="row mt-5">
        ...
        <span class="btn-principal col-md-4 col-sm-12 mx-1 text-center mb-5">
            <a href="../musica/cadastro.php">Adicionar Aluno +</a>
        </span>
        <div class="col-12 card d-flex flex-row justify-content-between">
            <div class="d-flex flex-column">
                <p class="m-0 display-6">Nome aluno</p>
                <p class="m-0 text-muted display-3 mb-2" style="font-size:14px">CPF: XXX.XXX.XXX-XX</p>
            </div>
