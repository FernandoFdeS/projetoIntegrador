<?php
    ...
    include '../../controller/curso/edit.php';
?>

<div class="container">
    <div class="row mt-5">
        <h1 class="mt-1 display-3">Editar Curso</h1>
        <form class="mt-5" action="../../controller/curso/update.php" method="POST">
            <?php
                echo '
                <div class="form-group mt-3">
                    <label for="nome">Nome: </label>
                    <input type="text" class="form-control" id="nome" name="nome" value="'.$curso['nome'].'" required placeholder="Nome do curso">
                </div>
                <div class="form-group mt-3">
                ...
                <!-- id -->
                <input type="hidden" class="form-control" id="id" name="id" value="'.$curso['id'].'">
